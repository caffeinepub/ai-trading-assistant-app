...
import type { Position as _Position, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addOrUpdatePosition(arg0: string, arg1: number, arg2: number, arg3: number | null, arg4: number | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addOrUpdatePosition(arg0, arg1, arg2, to_candid_opt_n8(this._uploadFile, this._downloadFile, arg3), to_candid_opt_n8(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLatestMarketBriefing(): Promise<string | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getLatestMarketBriefing();
    ...
    async getWatchlist(): Promise<Array<[string, string]>> {
        if (this.processError) {
            try {
    ...
    async updateMarketBriefing(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMarketBriefing(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ticker: value.ticker,
        takeProfit: record_opt_to_undefined(from_candid_opt_n12(_uploadFile, _downloadFile, value.takeProfit)),
        stopLoss: record_opt_to_undefined(from_candid_opt_n12(_uploadFile, _downloadFile, value.stopLoss)),
...
function from_candid_vec_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Position>): Array<Position> {
    return value.map((x)=>from_candid_Position_n10(_uploadFile, _downloadFile, x));
}
